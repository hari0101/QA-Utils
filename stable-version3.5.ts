...
class MyCustomReporter implements Reporter {
  ...
  private getCssContent(): string {
    return `
      ...
      .summary-info { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 20px 30px; padding: 15px 25px; background: var(--card-bg); border-radius: 10px; box-shadow: var(--shadow); margin-bottom: 30px; }
      ...
      .info-value { font-size: 1em; font-weight: 500; color: var(--text-color); }
      ...
      @media (max-width: 1200px) {
        ...
        .summary-info { justify-content: flex-start; }
      }
      ...
      @media (max-width: 768px) {
        ...
        .summary-info { flex-direction: column; align-items: flex-start; gap: 10px; }
      }
